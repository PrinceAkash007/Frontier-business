! function() {
    ...
    function P(t, n, i, e, o, s, a) {
        this.v = t, this.B = n, this.c = i, this.a = e, this.s = a || "BESbswy", this.f = {}, this.w = o || 3e3, this.u = s || null, this.o = this.j = this.h = this.g = null, this.g = new E(this.c, this.s), this.h = new E(this.c, this.s), this.j = new E(this.c, this.s), this.o = new E(this.c, this.s), t = new m(this.a.c + ",serif", j(this.a)), t = F(t), this.g.a.style.cssText = t, t = new m(this.a.c + ",sans-serif", j(this.a)), t = F(t), this.h.a.style.cssText = t, t = new m("serif", j(this.a)), t = F(t), this.j.a.style.cssText = t, t = new m("sans-serif", j(this.a)), t = F(t), this.o.a.style.cssText = t, W(this.g), W(this.h), W(this.j), W(this.o)
    }
    ...
    function L(t) {
        var n, i = t.g.a.offsetWidth,
            e = t.h.a.offsetWidth;
        (n = i === t.f.serif && e === t.f["sans-serif"]) || (n = B() && O(t, i, e)), n ? ot() - t.A >= t.w ? B() && O(t, i, e) && (null === t.u || t.u.hasOwnProperty(t.a.c)) ? $(t, t.v) : $(t, t.B) : D(t) : $(t, t.v)
    }
            ...
            if (0 === e.length && a) S(n.a);
                ...
                for (f = 0; f < e.length; f++) {
                    var l = e[f],
                        ...
                        p = n.a,
                        g = l;
                    p.g && r(p.f, [p.a.c("wf", g.c, j(g).toString(), "loading")]), C(p, "fontloading", g), p = null, null === ct && (ct = window.FontFace ? (g = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent)) ? 42 < parseInt(g[1], 10) : !0 : !1), p = ct ? new I(i(n.g, n), i(n.h, n), n.c, l, n.s, u) : new P(i(n.g, n), i(n.h, n), n.c, l, n.s, t, u), h.push(p)
                }
            ...
            if (2 <= e.length) {
                ...
                if (a = [], r)
                    for (var r = r.split(","), c = r.length, f = 0; c > f; f++) {
                        var h;
                        if (h = r[f], h.match(/^[\w-]+$/)) {
                            var l = pt.exec(h.toLowerCase());
                            if (null == l) h = "";
                            else {
                                if (h = l[2], h = null == h || "" == h ? "n" : ut[h], l = l[1], null == l || "" == l) l = "4";
                                else var u = lt[l],
                ...
                0 < a.length && (s = a), 3 == e.length && (e = e[2], a = [], e = e ? e.split(",") : a, 0 < e.length && (e = ht[e[0]]) && (t.c[o] = e))
            }
            for (t.c[o] || (e = ht[o]) && (t.c[o] = e), e = 0; e < s.length; e += 1) t.a.push(new m(o, s[e]))
        }
    }
    ...
    var it, et, ot = Date.now || function() {
            return +new Date
        },
        st = !!window.FontFace;
    w.prototype.c = function(t) {
        ...
        var t = this.c.m.document,
            ...
            e = new Promise(function(e, o) {
                function s() {
                    ot() - i >= n.f ? o() : t.fonts.load(y(n.a), n.h).then(function(t) {
    ...
    P.prototype.start = function() {
        this.f.serif = this.j.a.offsetWidth, this.f["sans-serif"] = this.o.a.offsetWidth, this.A = ot(), L(this)
    };
    var ct = null;
    q.prototype.g = function(t) {
        ...
        this.c = new e(this.j, t.context || this.j), this.g = !1 !== t.events, this.f = !1 !== t.classes, K(this, new _(this.c, t), t)
    }, M.prototype.load = function(t) {
        function n() {
            if (o["__mti_fntLst" + i]) {
                var e, s = o["__mti_fntLst" + i](),
                    a = [];
                if (s)
                    for (var r = 0; r < s.length; r++) {
                        var c = s[r].fontfamily;
                        void 0 != s[r].fontStyle && void 0 != s[r].fontWeight ? (e = s[r].fontStyle + s[r].fontWeight, a.push(new m(c, e))) : a.push(new m(c))
                    }
                t(a)
        ...
        var n, i, e = this.a.urls || [],
            ...
            a = new p;
        for (n = 0, i = e.length; i > n; n++) l(this.c, e[n], g(a));
        var r = [];
        for (n = 0, i = o.length; i > n; n++)
            if (e = o[n].split(":"), e[1])
                for (var c = e[1].split(","), f = 0; f < c.length; f += 1) r.push(new m(e[0], c[f]));
    ...
    Z.prototype.load = function(t) {
        ...
        n ? u(this.c, (this.a.api || "https://use.typekit.net") + "/" + n + ".js", function(n) {
            if (n) t([]);
                ...
                for (var e = [], o = 0; o < n.length; o += 2)
                    for (var s = n[o], a = n[o + 1], r = 0; r < a.length; r++) e.push(new m(s, a[r]));
                try {
                    i.Typekit.load({
                        events: !1,
                        classes: !1,
        ...
        n ? (i.__webfontfontdeckmodule__ || (i.__webfontfontdeckmodule__ = {}), i.__webfontfontdeckmodule__[n] = function(n, i) {
            for (var o = 0, s = i.fonts.length; s > o; ++o) {
                var a = i.fonts[o];
                e.a.push(new m(a.name, k("font-weight:" + a.weight + ";font-style:" + a.style)))
            }
            t(e.a)
    ...
    "function" == typeof et && et.amd ? et(function() {
        return vt
    }) : "undefined" != typeof it && it.exports ? it.exports = vt : (window.WebFont = vt, window.WebFontConfig && dt.load(window.WebFontConfig))
}();